...
describe('Schema validation', () => {
  ...
  describe('Route', () => {
    it('Should import the broken route and fix the schema', async () => {
      const fileContent = await fs.readFile(
        './test-new/data/res/schema-validation/route-export-broken.json',
        'utf-8'
      );
  ...
  describe('UUID deduplication (environment)', () => {
    ...
    it('should deduplicate UUIDs when opening another environment', async () => {
      await fs.copyFile(
        './test-new/data/res/schema-validation/uuid-dedup/env-to-load-1.json',
    ...
    it('should deduplicate UUIDs when importing another environment', async () => {
      await fs.copyFile(
        './test-new/data/res/schema-validation/uuid-dedup/env-to-import.json',
  ...
  describe('Missing mockoon format identifier', () => {
    it('should prompt before opening an environment where identifier (lastmigration) is missing', async () => {
      await fs.copyFile(
        './test-new/data/res/schema-validation/missing-identifier.json',
